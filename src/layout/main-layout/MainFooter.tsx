        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <h3 className="mb-4 text-3xl font-extrabold">
              <span className="mr-2 bg-gradient-to-r from-purple-500 to-pink-500 bg-clip-text text-purple-500">
                Edu
              </span>
            ...
            <p className="text-sm">
              Elevating your learning experience with cutting-edge online
              education.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <Link
              to="/contact"
              className="bg-gold mt-4 inline-flex transform items-center rounded from-purple-500 to-pink-500 px-4 py-2 text-white shadow-md transition-all duration-300 hover:scale-105 hover:bg-gradient-to-r hover:shadow-lg"
            >
