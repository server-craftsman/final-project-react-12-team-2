    ...
    <div>
      ...
      <form onSubmit={handleResend} className="flex flex-col gap-4">
        <input 
          ...
          required 
          className="rounded-lg border-2 border-gray-300 p-4 text-lg transition-all focus:border-[#1a237e] focus:outline-none focus:ring-2 focus:ring-[#1a237e] focus:ring-opacity-50" 
        />
        <button 
          type="submit" 
          className="bg-gradient-tone transform cursor-pointer rounded-lg px-8 py-4 text-lg font-semibold text-white transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
        >
