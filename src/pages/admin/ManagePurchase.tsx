...
const SearchPurchase = lazy(() => import('../../components/admin/SearchPurchase'));
const AmountPurchase = lazy(() => import('../../components/admin/AmountPurchase'));
const ViewPurchase = lazy(() => import('../../components/admin/ViewPurschase'));
