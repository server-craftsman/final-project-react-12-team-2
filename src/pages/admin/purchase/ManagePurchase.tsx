...
const ManagePurchase = () => {
  ...
  return (
    <div className="items-center justify-center border-b border-gray-300 p-4">
      ...
      <ViewPurchase searchQuery={searchQuery} />{" "}
      {/* Hiển thị danh sách purchase dựa trên tìm kiếm */}
