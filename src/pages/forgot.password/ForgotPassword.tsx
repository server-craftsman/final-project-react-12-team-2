  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white">
      <div className="w-full max-w-[400px] rounded-lg p-8">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-11 border-2 border-gray-300 rounded-full p-1">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className="w-full rounded-lg bg-gradient-tone py-2.5 text-white hover:bg-purple-700 disabled:bg-purple-400"
          >
        ...
        <div className="mt-6 text-center">
          <Link to={ROUTER_URL.LOGIN} className="text-sm text-[#02005dc6] hover:text-gray-700">Back to login</Link>
        </div>
      </div>
    </div>
  )
