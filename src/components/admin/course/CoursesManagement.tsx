    ...
    const columns = [
        ...
        },
        {
            ...
            render: (status: CourseStatusEnum) => (
                <span style={{ color: status === CourseStatusEnum.blocked ? 'red' : status === CourseStatusEnum.approve ? 'green' : 'black' }}>
                    {status === CourseStatusEnum.blocked ? 'Blocked' : getOrderStatus(status)}
                </span>
            ),
        },
        {
