    ...
    const columns = [
        {
            ...
            dataIndex: 'name',
            key: 'name',
            render: (name: string, record: GetCourseResponsePageData) => (
                <a onClick={() => handleShowModal(record._id)}>{name}</a>
            ),
        },
        {
            title: 'Status',
    ...
    return (
        <>
            ...
            <Modal
                ...
                footer={[
                    <Button key="close" onClick={() => setIsCourseLogModalVisible(false)}>Close</Button>
                ]}
            >
                <Table
                    columns={[
