    ...
    <div className="max-w-2xl mx-auto p-5">
      <Card title={`Purchase No: ${purchaseDetails.cart_no}`} className="shadow-lg">
        <Row gutter={16}>
          <Col span={12}>
            <Row>
              <Col span={12}><strong>Purchase ID:</strong></Col>
              <Col span={12}>{purchaseDetails.id}</Col>
            </Row>
            <Row>
              <Col span={12}><strong>Cart No:</strong></Col>
            ...
            <Row>
              <Col span={12}><strong>Price Paid:</strong></Col>
