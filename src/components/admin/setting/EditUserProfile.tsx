          ...
          user: {
            ...
            data: {
              ...
              verification_token_expires:
                userData.verification_token_expires.toString(),
    ...
    async (values: UpdateUserParams) => {
      ...
      try {
        ...
        await UserService.updateUser(
          id as string,
          updatedValues as UpdateUserParams,
        );
  ...
  if (!state.user) {
    ...
    return (
      <div className="max-w-10xl mx-auto rounded-xl bg-white p-8 shadow-2xl">
        <h1 className="mb-6 text-center text-3xl font-bold text-[#1a237e]">
          Edit User Profile
        </h1>
        <Form
          form={form}
        ...
        >
          ...
          <Form.Item
            label={<span className="font-medium text-[#1a237e]">Name</span>}
            name="name"
          ...
          <Form.Item
            label={
              <span className="font-medium text-[#1a237e]">Email Address</span>
            }
            name="email"
          ...
          <Form.Item
            label={
              <span className="font-medium text-[#1a237e]">Phone Number</span>
            }
            name="phone_number"
          ...
          <Form.Item
            label={
              <span className="font-medium text-[#1a237e]">Description</span>
            }
            name="description"
          ...
          <Form.Item
            label={
              <span className="font-medium text-[#1a237e]">Date of Birth</span>
            }
            name="dob"
            ...
            <DatePicker
              ...
              disabledDate={(current) => {
                ...
                const hundredYearsAgo = moment()
                  ...
                  .startOf("day");
                return (
                  current && (current > today || current < hundredYearsAgo)
                );
              }}
              placement="bottomLeft"
              style={{ width: "100%" }}
              defaultPickerValue={
                state.user?.data.dob ? dayjs(state.user.data.dob) : dayjs()
              }
              allowClear={false}
            />
          </Form.Item>
