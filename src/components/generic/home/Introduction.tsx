  ...
  return (
    <>
      <section className="mb-16 text-center">
        ...
        <Paragraph className="mx-auto max-w-3xl text-xl text-gray-700">
          Elevate your learning experience with our premium online education
          platform. Discover a world of knowledge curated by industry experts.
        </Paragraph>
      </section>
      ...
      <section className="mb-16">
        <Title
          level={2}
          className="mb-8 text-center text-4xl font-semibold text-indigo-800"
        >
