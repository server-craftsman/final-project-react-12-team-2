...
const UtilityProgram: React.FC = () => {
  return (
    <div className="flex space-x-4">
      ...
      <motion.div
        className="w-1/2 rounded-lg bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 shadow-md"
      ...
      >
        ...
        <motion.button
          className="rounded-full bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition duration-300 hover:bg-white hover:text-emerald-600"
      ...
      <motion.div
        className="w-1/2 rounded-lg bg-gradient-to-br from-rose-50 to-rose-100 p-6 shadow-md"
        whileHover={{ scale: 1.03 }}
        transition={{ type: "spring", stiffness: 300 }}
      >
        ...
        <motion.button
          className="rounded-full bg-rose-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition duration-300 hover:bg-white hover:text-rose-500"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
          View Programs
