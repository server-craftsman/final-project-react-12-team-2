...
const CreateCourseButton = () => {
  ...
  return (
    <>
      ...
      <Modal title="Create Course" open={isOpen} onOk={handleOk} onCancel={handleCancel} width={800} style={{ top: "20px" }}>
        <Form form={form} layout="vertical" initialValues={{ description, content }}>
          ...
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item name="image_url" initialValue="" label="Upload Image" rules={[{ required: true, message: "Please upload an image!" }]}>
                <Input />
              </Form.Item>
            </Col>
            <Col span={12}>
