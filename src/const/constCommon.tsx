...
export const Unauthorized = lazy(() => import("../components/generic/unauthorized/Unauthorized"));
...
export const lessonDetailsRoute = { path: "/course/:courseId/lesson/:lessonId", element: <LessonDetails /> };
export const cartRoute = { path: "cart", element: <CartPage /> };
export const unauthorizedRoute = { path: "/unauthorized", element: <Unauthorized /> };
